...
struct MEDIAPIPE_API  FAnimNode_MediaPipePose : public FAnimNode_MediaPipeBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="MediaPipe | Debug", meta = (PinHiddenByDefault))
	bool bDebugDraw = true;

	void DebugDraw(FPrimitiveDrawInterface* PDI, USkeletalMeshComponent* PreviewSkelMeshComp) const;
